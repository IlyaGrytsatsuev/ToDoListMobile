package com.example.todolist.network.services


import com.example.todolist.db.ToDoItemEntity
import com.example.todolist.network.responseModels.CreatedResponse
import com.example.todolist.network.responseModels.TestResponse
import com.example.todolist.network.responseModels.UploadLink
...
interface DiskApiService {
    ...
    suspend fun getFilesList(
        ...
        @Query("sort")
        sort:String = "created"): Response<TestResponse>
